...
<html>
<head>
    <title>Appointment Confirmed - Schedora</title>
    ...
    <style>
        ...
        .btn { background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: white; padding: 12px 24px; text-decoration: none; border-radius: 8px; font-weight: 600; display: inline-block; margin: 10px 5px; }
...
<body>
    <div class="header">
        ...
        <p style="margin: 10px 0 0 0; opacity: 0.9;">Your appointment has been accepted!</p>
    </div>
    ...
    <div class="content">
        ...
        <p style="color: #94a3b8; margin-bottom: 30px;">
            Great news! Your appointment with <strong>{{ $appointment->provider->user->name }}</strong> has been <strong>confirmed</strong>.
        </p>

        <div class="appointment-details">
            <h3 style="color: white; margin: 0 0 15px 0;">Confirmed Appointment</h3>
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; font-size: 15px;">
                <div>
                    <strong>Provider:</strong><br>
                    {{ $appointment->provider->user->name }}<br>
                    <small style="color: #94a3b8;">{{ $appointment->service->name ?? 'Service' }}</small>
                </div>
                <div>
        ...
        <p style="color: #94a3b8; font-size: 15px; margin-bottom: 20px;">
            Please proceed to payment to secure your appointment.
        </p>

        <div style="text-align: center;">
            <a href="{{ route('client.appointments') }}" class="btn">View My Appointments →</a>
        </div>

        <hr style="border: none; border-top: 1px solid #334155; margin: 40px 0;">

        <p style="color: #64748b; font-size: 14px;">
            Questions? <a href="#" style="color: #10b981;">Contact support</a>
        </p>
    </div>
