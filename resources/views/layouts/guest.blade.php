...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            /* Blue Theme Styles for Guest Layout */
            html {
        ...
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gradient-to-br from-blue-50 via-white to-blue-50">
            <div class="mb-6">
                <a href="/" class="flex items-center space-x-3">
                    ...
                    <span class="text-2xl font-bold text-gray-900">Schedora</span>
                </a>
            </div>

            <div class="w-full sm:max-w-md mt-6 px-6 py-6 bg-white shadow-xl overflow-hidden sm:rounded-lg border border-blue-100">
                {{ $slot }}
            </div>
        </div>
    </body>
