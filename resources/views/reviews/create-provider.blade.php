...
@section('content')
    <div class="py-12">
        <div class="max-w-2xl mx-auto px-6 lg:px-8">
            <!-- Page Header -->
            <div class="mb-8">
                <h1 class="font-heading text-3xl font-bold text-white">Rate Client</h1>
                <p class="text-white/60 mt-2">Share your experience with {{ $appointment->client->name ?? 'your client' }}</p>
            </div>
            ...
            <div class="glass-card rounded-xl p-8">
                ...
                <form action="{{ route('provider-reviews.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="flex gap-4">
                        <a href="{{ route('provider.appointments') }}" class="flex-1 text-center py-3 px-6 rounded-lg border border-white/20 text-white/70 hover:bg-white/5 transition-colors">
                            Cancel
                        </a>
