...
@section('content')
    <div class="py-12">
        <div class="max-w-7xl mx-auto px-6 lg:px- Page Header -->
           8">
            <!-- <div class="mb-8">
                <h1 class="font-heading text-3xl font-bold text-white">Create User</h1>
                <p class="text-white/60 mt-2">Add a new user</p>
            </div>
