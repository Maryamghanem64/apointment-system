            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            <a href="{{ route('provider.dashboard') }}" class="block p-4 border border-gray-200 rounded-lg hover:bg-gray-50">
                                <h4 class="font-medium text-gray-900">{{ __('Working Hours') }}</h4>
                                <p class="text-sm text-gray-500 mt-1">{{ __('Manage your working schedule.') }}</p>
                            </a>
                        </div>
                        
                        <div>
                            <a href="{{ route('provider.dashboard') }}" class="block p-4 border border-gray-200 rounded-lg hover:bg-gray-50">
                                <h4 class="font-medium text-gray-900">{{ __('Holidays') }}</h4>
                                <p class="text-sm text-gray-500 mt-1">{{ __('Set your available dates.') }}</p>
                            </a>
                        </div>
                    </div>
                </div>
