...
<div class="py-12">
    <div class="max-w-2xl mx-auto px-6 lg:px-8">
        <div class="flex items-center mb-8">
            ...
            <h1 class="text-3xl font-bold text-white ml-4">Add New Service</h1>
        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" min="1" name="duration" value="{{ old('duration') }}" required 
                                class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white focus:border-cyan-400 focus:ring-1 transition">
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="3" class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-white/30 focus:border-cyan-400 focus:ring-1 transition">{{ old('description') }}</textarea>
