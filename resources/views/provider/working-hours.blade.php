                    ...
                    <div class="flex items-center gap-3 flex-1"
                        ...
                        <div class="flex items-center gap-2 flex-1">
                            ...
                            <input type="time"
                                ...
                                value="{{ $existing ? \Carbon\Carbon::parse($existing->start_time)->format('H:i') : '09:00' }}"
                        ...
                        <div class="flex items-center gap-2 flex-1">
                            ...
                            <input type="time"
                                ...
                                value="{{ $existing ? \Carbon\Carbon::parse($existing->end_time)->format('H:i') : '17:00' }}"
                                class="flex-1 bg-white/5 border border-white/10 rounded-xl px-3 py-2 text-white text-sm focus:outline-none focus:border-cyan-400 transition-all duration-300"
                                style="color-scheme:dark;">
                        </div>
                ...
                <table class="w-full">
                    ...
                    <tbody>
                        ...
                        @php
                            ...
                            $isSoon = \Carbon\Carbon::parse($holiday->date)->isFuture()
                                && \Carbon\Carbon::parse($holiday->date)->diffInDays(now()) <= 7;
                        @endphp
