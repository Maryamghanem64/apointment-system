...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-blue-500 text-sm font-semibold leading-5 text-blue-600 focus:outline-none focus:border-blue-700 transition duration-150 ease-in-out'
