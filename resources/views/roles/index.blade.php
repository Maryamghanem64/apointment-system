    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-6 flex justify-between items-center">
                <h3 class="text-lg font-semibold text-gray-900">{{ __('All Roles') }}</h3>
                <a href="{{ route('roles.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
                ...
                <div class="p-6">
                                    ...
                                    @foreach($roles as $role)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                                ...
                                                @if($role->name !== 'admin' && $role->name !== 'client' && $role->name !== 'provider')
                    ...
                    @else
                        <div class="text-center py-12">
                            ...
                            <p class="mt-1 text-sm text-gray-500">{{ __('Get started by adding a new role.') }}</p>
                            <div class="mt-6">
